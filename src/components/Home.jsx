...
export const Home = ({darkTheme, setDarkTheme}) => {
  ...
  return (
    ...
    <div className='h-screen w-3/4 mx-auto grid grid-cols-1 place-content-center'>
      ...
      <img src={logo} alt="logo" className='w-80 mx-auto lg:w-96' />
      <div className='relative w-full mt-3 sm:mt-4'>
        <div className=''>
        <form className='flex my-4  lg:w-3/5 lg:mx-auto text-xl' onSubmit={() => {
          handleText(text)
        ...
        <input 
          ...
          className="w-full h-0 dark:bg-gray-900 dark:border-gray-700 dark:text-white border rounded-tl-2xl rounded-bl-2xl shadow-sm outline-none px-4 py-6 lg:py-8 text-black hover:shadow-lg" />
